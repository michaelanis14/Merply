...
return true;
	...
	if(Count("OrederIn::%\"") < 0){
		...
		Database* databaseStores  =new Database();
		...
		Database* databaseClients  =new Database();
		...
		Database* databaseSuppliers  =new Database();
		...
		Database* databaseProducts  =new Database();
