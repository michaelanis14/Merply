...
void MainWindow::openFile() {
	...
	if(fileName.contains(".xml")){
		...
		xmlDoc->setContent(loadedXmlJson.object().value("XMLSTRCT").toString());
		}
...
void MainWindow::saveReport() {
	...
	docElem.setAttribute("programmer","Michael Bishara");
	docElem.setAttribute("email","michaelanis@me.com");
...
void MainWindow::gotDocument(QJsonDocument doc)
{
	loadedXmlJson = doc;
	openFile();
}
